...
const Footer = () => {
  return (
    <footer className="bg-navy-deep py-12 pb-28 lg:pb-12">
      <div className="container mx-auto">
        ...
        <div className="mt-8 pt-6 border-t border-primary-foreground/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <nav className="flex gap-6 text-xs text-primary-foreground/40">
            ...
            <a href="#services" className="hover:text-primary-foreground/70 transition">Services</a>
            <a href="#reviews" className="hover:text-primary-foreground/70 transition">Reviews</a>
            <a href="#booking" className="hover:text-primary-foreground/70 transition">Book</a>
          </nav>
        </div>
      </div>
    </footer>
